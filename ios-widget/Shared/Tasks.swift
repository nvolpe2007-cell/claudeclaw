...
/// The bundled list of "nudges" — small, harmless challenges that gently
/// defy an everyday social norm. Shipping these inside the app means the
/// widget works instantly, offline, with zero backend.
///
